...
public:
    ...
    BootstrapService(AuthdEventFactory* eventFactory, AuthdActionFactory* actionFactory);
    ...
    void handleEvent(AuthdServiceManager& serviceManager, const BootstrapEvent& event);

    void handleAction(AuthdServiceManager& serviceManager, const BootstrapAction& action);

private:
    void onServerHello(AuthdServiceManager& serviceManager, const pz::ipc::IpcMessage& msg);
