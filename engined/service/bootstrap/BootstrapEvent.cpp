...
BootstrapEvent::BootstrapEvent(BootstrapEventType type) : EnginedEvent(EnginedEventDomain::Bootstrap), m_type(type)
{
}

BootstrapEvent::BootstrapEvent(BootstrapEventType type, std::unique_ptr<pz::ipc::IpcMessage> message)
    : EnginedEvent(EnginedEventDomain::Bootstrap), m_type(type), m_message(std::move(message))
{
}
