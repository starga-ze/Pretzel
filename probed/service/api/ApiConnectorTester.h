...
//
// There is no router here, unlike mgmtd: collectord routes a single IPC event, not many URLs, so the
...
public:
    ...
    static void run(ApiService& api, ProbedServiceManager& sm, std::uint32_t seqNo,
